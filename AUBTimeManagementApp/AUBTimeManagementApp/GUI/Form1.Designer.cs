namespace AUBTimeManagementApp.GUI
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.findTime = new System.Windows.Forms.Button();
			this.SuspendLayout();
			// 
			// AddTeamButton
			// 
			...
			this.freeTime.Size = new System.Drawing.Size(292, 201);
			this.freeTime.TabIndex = 4;
			this.freeTime.Text = "Free time:";
			// 
			// findTime
			// 
			this.findTime.Location = new System.Drawing.Point(706, 329);
			this.findTime.Name = "findTime";
			this.findTime.Size = new System.Drawing.Size(266, 51);
			this.findTime.TabIndex = 6;
			this.findTime.Text = "Find Free Time";
			this.findTime.UseVisualStyleBackColor = true;
			this.findTime.Click += new System.EventHandler(this.findTime_Click);
			// 
			// Form1
			// 
        ...
        private System.Windows.Forms.Button findTime;
    }
}