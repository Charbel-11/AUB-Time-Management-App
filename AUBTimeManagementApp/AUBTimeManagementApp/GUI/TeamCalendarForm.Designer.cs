namespace AUBTimeManagementApp.GUI {
    partial class TeamCalendarForm {
        ...
        calendarHighlightRange5};
			...
			// addEventButton
			// 
			this.addEventButton.ImageIndex = 4;
			...
			this.imageList1.Images.SetKeyName(7, "invitation.png");
			this.imageList1.Images.SetKeyName(8, "user.png");
			this.imageList1.Images.SetKeyName(9, "intersection.png");
			this.imageList1.Images.SetKeyName(10, "calendar (1).png");
			// 
			// teamSchedButton
			// 
			this.teamSchedButton.ImageIndex = 10;
			...
			// mergedSchedButton
			// 
			this.mergedSchedButton.ImageIndex = 9;
